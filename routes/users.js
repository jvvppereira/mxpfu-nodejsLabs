...
router.get("/:email", (req, res) => {
    // Copy the code here
    res.send(users.filter(u => u.email == req.params.email))//This line is to be replaced with actual return value
});
...
router.post("/", (req, res) => {
    ...
    users.push(user)
    res.send(`The user ${user.firstName} has been added`)//This line is to be replaced with actual return value
});
